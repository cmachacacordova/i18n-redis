...
i18n::Translation::Translation(std::unique_ptr<TranslationProvider> provider_, std::string defaultLocale_)
    : provider(std::move(provider_)), defaultLocale(std::move(defaultLocale_)) {}
